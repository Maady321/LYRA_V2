      ...
      {settingsOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-[400px] bg-darkSurface border-l border-slate-800/40 shadow-premium z-50 flex flex-col font-sans select-none"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-800/40">
              <div className="flex items-center gap-2.5">
                <Sliders className="w-5 h-5 text-brandBlue animate-pulse" />
                <span className="font-semibold text-lg text-slate-100">Lyra Preferences</span>
              </div>
              <button
                onClick={toggleSettings}
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-widest">
                  <MessageSquare className="w-3.5 h-3.5 text-brandBlue/80" />
                  <span>System core directive</span>
                </div>
                <textarea
                  value={settings.system_prompt}
                  onChange={(e) => updateSetting('system_prompt', e.target.value)}
                  className="w-full h-32 bg-darkBg border border-slate-800/60 rounded-xl px-3 py-2.5 text-sm text-slate-300 placeholder-slate-600 focus:outline-none focus:border-brandBlue/50 focus:shadow-glow resize-none font-sans transition-all duration-300"
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-widest">
                    <Compass className="w-3.5 h-3.5 text-brandBlue/80" />
                    <span>Inference Temperature</span>
                  </div>
                  <span className="text-xs font-mono font-bold text-brandBlue">{settings.temperature.toFixed(2)}</span>
                </div>
                <input
                  type="range"
                  min="0.0"
                  ...
                  className="w-full accent-brandBlue bg-darkBg h-1 rounded-lg cursor-pointer"
                />
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-widest">
                    <Terminal className="w-3.5 h-3.5 text-brandBlue/80" />
                    <span>Max tokens to predict</span>
                  </div>
                  <span className="text-xs font-mono font-bold text-slate-300">{settings.max_tokens}</span>
                </div>
                    ...
                    <button
                      ...
                      className={`py-1.5 rounded-lg border text-xs font-mono transition-all duration-300 ${
                        settings.max_tokens === tokens
                          ? 'bg-brandBlue/10 border-brandBlue/40 text-brandBlue'
                          : 'bg-darkBg/60 border-slate-800/40 text-slate-400 hover:border-slate-700/60'
                      }`}
                    >
                      {tokens}
                    </button>
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-widest">
                    <Sliders className="w-3.5 h-3.5 text-brandBlue/80" />
                    <span>Context Window size</span>
                  </div>
                  <span className="text-xs font-mono font-bold text-slate-300">{settings.context_window}</span>
                </div>
                <div className="grid grid-cols-4 gap-2">
              ...
              <div className="space-y-2.5 pt-2 border-t border-slate-850/40">
                <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-widest">
                  <Volume2 className="w-3.5 h-3.5 text-brandBlue/80" />
                  <span>Voice Wake Word System</span>
                </div>
                
                <div className="flex items-center justify-between p-3.5 bg-darkBg/60 border border-slate-800/40 rounded-2xl hover:border-slate-800/80 transition-all duration-300">
                  <div className="space-y-0.5 max-w-[240px]">
                    <span className="text-xs font-bold text-slate-200">"Hai Lyra" Voice Wake</span>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      settings.wake_system_enabled ? 'bg-brandBlue shadow-glow' : 'bg-slate-800'
                    }`}
                  >
                    <span
                      aria-hidden="true"
              ...
              <div className="space-y-2.5 pt-2 border-t border-slate-850/40">
                ...
                <div className="flex items-center justify-between p-3.5 bg-darkBg/60 border border-slate-800/40 rounded-2xl hover:border-slate-800/80 transition-all duration-300">
                  <div className="space-y-0.5 max-w-[240px]">
                    <span className="text-xs font-bold text-slate-200">Response Readout (TTS)</span>
                    <p className="text-[10px] text-slate-500 leading-normal">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      settings.tts_enabled ? 'bg-brandBlue shadow-glow' : 'bg-slate-800'
                    }`}
                  >
                    <span
                      aria-hidden="true"
              ...
              <div className="space-y-2.5 pt-2 border-t border-slate-850/40">
                ...
                <div className="flex items-center justify-between p-3.5 bg-darkBg/60 border border-slate-800/40 rounded-2xl hover:border-slate-800/80 transition-all duration-300">
                  <div className="space-y-0.5 max-w-[240px]">
                    <span className="text-xs font-bold text-slate-200">Enable Text Chat</span>
                    <p className="text-[10px] text-slate-500 leading-normal">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      settings.chat_enabled ? 'bg-brandBlue shadow-glow' : 'bg-slate-800'
                    }`}
                  >
                    <span
                      aria-hidden="true"
            ...
            {/* Footer */}
            <div className="px-6 py-4 bg-darkBg/80 border-t border-slate-800/40 text-center">
